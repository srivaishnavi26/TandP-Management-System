...
urlpatterns = [
    ...
    path('admin/staff/make_admin/<int:staff_id>/', views.make_staff_admin, name='make_staff_admin'),
    path('admin/messages/delete/<int:message_id>/', views.delete_message, name='delete_message'),
    path('admin/drives/delete/<int:drive_id>/', views.delete_drive, name='delete_drive'),
